...
export class PipelineApiService {
  ...
  async searchPipelines(
    ...
    if (criteria.includeInactive !== undefined) params.append('includeInactive', String(criteria.includeInactive)); //hace que los pipelines eliminados no aparezcan en la lista
